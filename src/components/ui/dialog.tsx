  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "flex flex-col max-h-[85vh] sm:max-h-[90vh] overflow-hidden rounded-t-xl sm:rounded-lg",
        className,
      )}
      {...props}
    >
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 px-6 pb-6 pt-4 shrink-0 border-t bg-background", className)} {...props} />
);
