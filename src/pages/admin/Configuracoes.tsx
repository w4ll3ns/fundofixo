    ...
    <AppLayout>
      <div className="space-y-6 animate-fade-in">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie usuários, domínios permitidos e acessos consultivos</p>
        </div>
        ...
        <Tabs defaultValue="usuarios" className="space-y-4">
          <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:inline-grid">
            ...
            <TabsTrigger value="acessos" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline">Acessos Consultivos</span>
            </TabsTrigger>
          </TabsList>
